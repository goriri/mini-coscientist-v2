...
from .models import DISCIPLINES, STAGES
...
def _create_registry() -> dict[str, DisciplineProfile]:
    ...
    registry["chemistry_materials"] = DisciplineProfile(
        ...
        stage_checklists=_build_default_stage_checklists("chemistry and materials science"),
    )
    ...
    registry["neuroscience_cognitive"] = DisciplineProfile(
        ...
        stage_checklists=_build_default_stage_checklists("neuroscience and cognitive science"),
    )
    ...
    registry["social_science_economics"] = DisciplineProfile(
        ...
        stage_checklists=_build_default_stage_checklists("social science and economics"),
    )
    ...
    registry["environmental_ecology"] = DisciplineProfile(
        ...
        stage_checklists=_build_default_stage_checklists("environmental and ecology science"),
    )
    ...
    registry["general_interdisciplinary"] = DisciplineProfile(
        ...
        stage_checklists=_build_default_stage_checklists("general interdisciplinary science"),
    )
...
def get_discipline_profile(discipline: str) -> DisciplineProfile:
    ...
    return DISCIPLINE_REGISTRY.get(discipline, DISCIPLINE_REGISTRY["general_interdisciplinary"])
