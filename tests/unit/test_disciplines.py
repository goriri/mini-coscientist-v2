...
def test_discipline_dynamic_prompt_loading():
    ...
    cs_question = "Benchmark a machine learning optimizer algorithm on an image dataset."
    ...
    assert "Algorithmic Complexity, Dataset Diversity, Baseline Superiority" in actor_prompt
